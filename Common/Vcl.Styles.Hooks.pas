...
//procedure OutputDebugString(lpOutputString: PWideChar);
//begin
//   TFile.AppendAllText('C:\Dephi\google-code\vcl-styles-plugins\InnoSetup plugin\Samples\log.txt',Format('%s %s %s',[FormatDateTime('hh:nn:ss.zzz', Now),  string(lpOutputString), sLineBreak]));
//end;
...
//  else
//      OutputDebugString(PChar(Format('Detour_UxTheme_DrawThemeMain  class %s hTheme %d iPartId %d iStateId %d', ['Desconocido',hTheme, iPartId, iStateId])));

...
#define MyAppVersion GetFileVersion('Lite\VclStylesinno.dll')
[Setup]
AppName={#MyAppName}
...
OutputDir=.\Output
OutputBaseFilename=SetupVCLStylesInno_Lite
VersionInfoVersion={#MyAppVersion}
VersionInfoCompany=The Road To Delphi
VersionInfoDescription=VCL Styles Lite for Inno Setup
InternalCompressLevel=max

[Files]
Source: Lite\VclStylesinno.dll; DestDir: {app}
